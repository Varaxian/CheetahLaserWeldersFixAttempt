...
namespace Cheetah.Radars
{
    ...
    public class SessionCore : MySessionComponentBase
    {
        ...
        public static void InitWelderControls()
        {
            ...
            MyAPIGateway.TerminalControls.AddControl<Sandbox.ModAPI.IMyShipWelder>(Controls.LaserBeam<Sandbox.ModAPI.IMyShipWelder>());
            MyAPIGateway.TerminalControls.AddControl<Sandbox.ModAPI.IMyShipWelder>(Controls.SpeedMultiplier<Sandbox.ModAPI.IMyShipWelder>());
            var DistanceMode = Controls.DistanceMode<Sandbox.ModAPI.IMyShipWelder>();
            ...
            MyAPIGateway.TerminalControls.AddControl<Sandbox.ModAPI.IMyShipWelder>(DistanceMode);
        ...
        public static void InitGrinderControls()
        {
            ...
            MyAPIGateway.TerminalControls.AddControl<Sandbox.ModAPI.IMyShipGrinder>(Controls.LaserBeam<Sandbox.ModAPI.IMyShipGrinder>());
            MyAPIGateway.TerminalControls.AddControl<Sandbox.ModAPI.IMyShipGrinder>(Controls.SpeedMultiplier<Sandbox.ModAPI.IMyShipGrinder>());
            var DistanceMode = Controls.DistanceMode<Sandbox.ModAPI.IMyShipGrinder>();
            ...
            MyAPIGateway.TerminalControls.AddControl<Sandbox.ModAPI.IMyShipGrinder>(DistanceMode);
